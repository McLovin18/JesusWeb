...
import ProductoForm from "../app/admin/inventario/ProductoForm";
...
export default function ProductoFormModal({ show, onClose, initialData, onSave }: ProductoFormModalProps) {
  if (!show) return null;
  return (
