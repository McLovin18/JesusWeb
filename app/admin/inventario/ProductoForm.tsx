      ...
      <div className="flex flex-col gap-5 bg-slate-50/60 dark:bg-slate-800/40 rounded-2xl p-5 border border-slate-200 dark:border-slate-700">
        ...
        <div className="flex gap-4 mt-8">
          <button
            type="submit"
            className={
              `bg-gradient-to-r from-purple-700 via-purple-500 to-purple-700 hover:from-purple-800 hover:to-purple-900 text-white font-bold py-3 px-8 rounded-xl shadow-lg text-lg transition-all duration-200 flex items-center justify-center gap-2 ${loading ? 'opacity-60 cursor-not-allowed' : ''}`
            }
            disabled={loading}
          >
            {loading && (
